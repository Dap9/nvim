-- This is a hack, since `on_attach` doesnt seem to be working for lspconfig setup anymore
-- TODO: fix this and create something more permanent
vim.api.nvim_create_augroup("Lsp attach functions", { clear = true })
